          ...
          <div className='first__row__item w-80 md:w-[450px] my-8 bg-[#fefcfb] rounded-3xl relative shadow-sm'>
            ...
            <div className='p-3 md:p-6'>
              <div className='pt-3 md:pt-5'>
                ...
                <p className='text-gray-900 opacity-60 text-sm'>“Pengalaman yang sangat menyenangkan, di tambah pelayananya ramah banget, top banget, rekomend buat yang mau cobain!”</p>
              </div>
            </div>
          </div>
        </div>
