...
const Productdetailsview = ({ item, productDetails }) => {
    console.log(productDetails)

    const [mainImage, setMainImage] = React.useState(`http://localhost:1337${productDetails.productImage1.data.attributes.url}`);
    const [capacityValue, setCapacityValue] = React.useState(productDetails);
    const [deliveryAvailabilityCity, setDeliveryAvailabilityCity] = React.useState(null);
    const [originalPrice, setOriginalPrice] = React.useState(productDetails?.defaultOriginalPrice);
        ...
        <div className="ProductDetailsPage my-8">
            ...
            <div className="ProductDetailsPage__container max-w-7xl mx-auto ">
                ...
                <div className="Product__image__specification flex justify-center flex-wrap ">
                    <div className="Product__image flex flex-col ">
                        <div className="border-2 bg-gray-200 border-gray-200 rounded-xl m-2 ">
                            <div className="bg-gray-200 rounded-t-xl">
                                ...
                                <div className="mainImage__container aspect-4/3">
                                    <Image className="pb-2 max-w-[300px] sm:max-w-[440px]  lg:max-w-[510px] lg:max-h-[350px] "
                                        loading="lazy"
                                        src={mainImage}
                                        width={1000}
                                        height={1000}
                            ...
                            <div className={`flex justify-center items-center w-[6.5rem] h-[30px] ${productDetails.productInStock > 0 ? 'border-green-500 text-green-500' : 'border-rose-500 text-rose-500'} bg-gray-50 border rounded-full ml-4 mb-4`}>
                                <p className="flex text-xs">
                                    {productDetails.productInStock > 0 ? "In Stock" : "Out of Stock"}
                                </p>
                            </div>
                        </div>
                        <div className="Product__images__container flex m-2 space-x-1 justify-between ">
                            <button className="rounded-xl border hover:border-green-500 focus:border-green-500 bg-gray-200 w-[95px] lg:w-[163px] sm:w-[145px] aspect-4/3">
                                <Image onClick={() => setMainImage(prev => prev = `http://localhost:1337${productDetails.productImage1.data.attributes.url}`)}
                                    className="py-6"
                                    loading="lazy"
                                    src={`http://localhost:1337${productDetails.productImage1.data.attributes.url}`}
                                    width={1000}
                                    height={1000}
                                    alt="Image is loading..."
                                />
                            ...
                            <button className="rounded-xl border hover:border-green-500 focus:border-green-500 bg-gray-200 w-[95px] lg:w-[163px] sm:w-[145px] aspect-4/3">
                                <Image onClick={() => setMainImage(prev => prev = `http://localhost:1337${productDetails.productImage2.data.attributes.url}`)}
                                    className="py-6"
                                    loading="lazy"
                                    src={`http://localhost:1337${productDetails.productImage2.data.attributes.url}`}
                                    width={1000}
                                    height={1000}
                                    alt="Image is loading..."
                                />
                            ...
                            <button className="rounded-xl border hover:border-green-500 focus:border-green-500 bg-gray-200 w-[95px] lg:w-[163px] sm:w-[145px] aspect-4/3">
                                <Image onClick={() => setMainImage(prev => prev = `http://localhost:1337${productDetails.productImage3.data.attributes.url}`)}
                                    className="py-6  "
                                    loading="lazy"
                                    src={`http://localhost:1337${productDetails.productImage3.data.attributes.url}`}
                                    width={1000}
                                    height={1000}
                                    alt="Image is loading..."
                                />
                    ...
                    <div className="Product__text__specification flex flex-col sm:space-y-2 space-y-1">
                        ...
                        <div className="ProductPrice mx-2 flex items-center justify-center sm:justify-start">
                            <span className="text-[#10b981] text-2xl">₹{originalPrice} </span>
                            ...
                            <div className="withExchangePrice__container">
                                ...
                                <label className="withExchangePrice__container box-border m-2 border-gray-200 bg-gray-50 border h-16 w-60 flex items-center rounded-xl hover:border-green-500  text-left cursor-pointer" htmlFor="withExchangePrice">
                                    ...
                                    <div className="withExchangePrice flex flex-col">
                                        ...
                                        <p className="  text-xs text-gray-700">₹{productDetails.productWithExchange}</p>
                                    </div>
                                </label>
                            </div>
                            <div className="withoutExchangePrice__container">
                                ...
                                <label className="withoutExchangePrice__container box-border m-2 border-gray-200 bg-gray-50 border h-16 w-60 flex items-center rounded-xl hover:border-green-500  text-left cursor-pointer" htmlFor="withoutExchangePrice">
                                    ...
                                    <div className="withExchangePrice flex flex-col">
                                        ...
                                        <p className="  text-xs text-gray-700">₹{productDetails.productWithoutExchange}</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                            ...
                            <div className="withTrolleyPrice__container">
                                ...
                                <label className="withExchangePrice__container box-border m-2 border-gray-200 bg-gray-50 border h-16 w-60 flex items-center rounded-xl hover:border-green-500  text-left cursor-pointer" htmlFor="withTrolleyPrice">
                                    ...
                                    <div className="withExchangePrice flex flex-col">
                                        ...
                                        <p className="  text-xs text-gray-700">₹{productDetails.productWithTrolley}</p>
                                    </div>
                                </label>
                            </div>
                            <div className="withoutTrolleyPrice__container">
                                ...
                                <label className="withoutTrolleyPrice__container box-border m-2 border-gray-200 bg-gray-50 border h-16 w-60 flex items-center rounded-xl hover:border-green-500  text-left cursor-pointer" htmlFor="withoutTrolleyPrice">
                                    ...
                                    <div className="withTrolleyPrice flex flex-col">
                                        <p className=" text-sm text-gray-700">WITHOut EXCHANGE</p>
                                        <p className="  text-xs text-gray-700">₹{productDetails.productWithoutTrolley}</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="capacity__replacements flex flex-wrap justify-center sm:justify-start " >
                            ...
                            <div className="warranty box-border m-2 border-gray-200 bg-gray-50  border h-16 w-40 flex items-center rounded-xl">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="  text-xs text-gray-700">{productDetails.productWarranty}</p>
                                </div>
                            </div>
                            <div className="replacement box-border m-2 border-gray-200 bg-gray-50  border h-16 w-40 flex items-center rounded-xl">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="  text-xs text-gray-700">{productDetails.replacement}</p>
                                </div>
                            </div>
                        ...
                        <div className="delivery__shareProduct flex flex-wrap gap-x-5 sm:gap-1 justify-center sm:justify-start">
                            <div className="delivery__citysm:space-y-6 space-y-2 my-3 mx-2">
                                ...
                                {/* <CheckDeliveryAvaibility deliveryAvailabilityCity={deliveryAvailabilityCity} setDeliveryAvailabilityCity={setDeliveryAvailabilityCity} data={item.deliveryCity} defaultDeliveryCity={item.defaultDeliveryCity} /> */}
                            </div>
                        ...
                        <div className="buynow__addtocart__buttons flex justify-center sm:justify-start">
                            <button className=" text-[#10b981] hover:text-gray-50  bg-gray-50 border hover:bg-[#10b981] border-[#10b981] rounded-full w-28 h-9 mx-2">
                                Buy Now
                            </button>
                            <button className=" text-[#10b981] hover:text-gray-50  bg-gray-50 border hover:bg-[#10b981] border-[#10b981] rounded-full w-28 h-9 mx-2">
                                Add to cart
                ...
                <div className="Product__note mx-4 sm:mx-16 my-8">
                    ...
                    <p className="text-sm sm:text-base">{productDetails.productNote}</p>
                </div>
                <div className="Product__features mx-4 sm:mx-16 my-8">
                    <p className="sm:text-[2rem]  text-[1.3rem] font-semibold" >Features</p>
                    <p className="text-sm sm:text-base">{productDetails.productFeatures}</p>
                </div>
                <div className="Product__table__specification mx-4 sm:mx-16 my-8 ">
                    ...
                    {
                        Object.entries(productDetails.productSpecifications).map(([key, value]) => <div key={key} className="flex justify-between max-[900px]:w-[80vw]  w-[54vw] border-x-2 border-t-2 border-gray-200 p-2">
                            <p className="text-xs sm:text-base">{key}</p>
                            <p className="text-xs sm:text-base">{value}</p>
                        </div>)
                    }
                </div>
            </div>
